          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: '4px', flex: 1, justifyContent: 'center' }}>
            ...
            <div style={{ position: 'relative' }} onMouseEnter={() => setMenuOpen('support')} onMouseLeave={() => setMenuOpen(null)}>
              <span style={{
                ...
                padding: '7px 16px', borderRadius: '4px',
                fontSize: '0.88rem', fontWeight: 500,
                color: pathname.startsWith('/contact') ? '#ffffff' : '#374151',
                cursor: 'pointer',
                background: pathname.startsWith('/contact') ? '#0066cc' : (menuOpen === 'support' ? '#f0f7ff' : 'transparent'),
              }}>
                Support
            ...
            <div style={{ position: 'relative' }} onMouseEnter={() => setMenuOpen('about')} onMouseLeave={() => setMenuOpen(null)}>
              <span style={{
                ...
                color: pathname.startsWith('/about') ? '#ffffff' : '#374151',
                cursor: 'pointer',
                background: pathname.startsWith('/about') ? '#0066cc' : (menuOpen === 'about' ? '#f0f7ff' : 'transparent'),
              }}>
                About Us
                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5"><polyline points="6 9 12 15 18 9"/></svg>
              </span>
